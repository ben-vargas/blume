...
describe("per-locale navigation", () => {
  ...
  it("localizes header tab paths per locale", async () => {
    ...
    // An external declared href passes through localization untouched.
    expect(graph.navigationByLocale.fr?.tabs?.[3]?.href).toBe(
