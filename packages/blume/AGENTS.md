...
- `./skills/blume-migrate/SKILL.md` — migrate an existing docs site (Mintlify, Docusaurus, Fumadocs, Nextra, Starlight, or another framework) to Blume. `blume migrate [source] --claude` (or `--codex`) opens an agent on it.
