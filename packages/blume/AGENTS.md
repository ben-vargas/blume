...
- `./skills/blume-migrate/SKILL.md` — migrate an existing docs site (Mintlify, Fumadocs, Docusaurus, Starlight, Nextra, or another framework) to Blume. `blume migrate [source] --claude` (or `--codex`) opens an agent on it.
