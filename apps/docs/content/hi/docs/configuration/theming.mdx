...
| `--blume-action-foreground` | एक्शन बैकग्राउंड पर टेक्स्ट और आइकन (डिफ़ॉल्ट रूप से एक्सेंट फ़ोरग्राउंड) |
| `--blume-code-background` | कोड ब्लॉक सतह |
| `--blume-code-highlight`, `--blume-code-highlight-border` | हाइलाइट की गई कोड लाइन का बैकग्राउंड और बाईं रेखा (`// [!code highlight]` या कोई `{1,4-5}` रेंज) |
| `--blume-code-add`, `--blume-code-add-border` | जोड़ी गई लाइन का बैकग्राउंड और बाईं रेखा (`// [!code ++]`) |
| `--blume-code-remove`, `--blume-code-remove-border` | हटाई गई लाइन का बैकग्राउंड और बाईं रेखा (`// [!code --]`) |
| `--blume-code-word`, `--blume-code-word-border` | हाइलाइट किए गए शब्द का बैकग्राउंड और आउटलाइन (`// [!code word:…]`) |
| `--blume-content-width` | प्रोज़ कॉलम की अधिकतम चौड़ाई — लेख, ब्रेडक्रंब, विषय-सूची, फ़ीडबैक, और पेजिनेशन (डिफ़ॉल्ट `42rem`) |
