...
| `blume add [item]` | रजिस्ट्री से एक सोर्स कंपोनेंट इंस्टॉल करें (item न देने पर उपलब्ध आइटम की सूची दिखाई जाती है)। |
...
| [`blume migrate [source]`](/docs/migrating) | Codex या Claude Code की मदद से किसी Mintlify, Fumadocs, Docusaurus, Starlight या Nextra साइट को Blume पर ले जाएँ। |
| [`blume upgrade`](/docs/upgrading) | नए मेजर संस्करण पर जाएँ: `blume` का संस्करण बढ़ाएँ, फिर बचे हुए कॉन्फ़िग बदलावों की सूची देखें या उन्हें Codex या Claude Code को सौंप दें। |
...
- `blume sync --preview` — ड्राफ़्ट और अप्रकाशित CMS कंटेंट शामिल करें।
- `blume sync --strict` — डायग्नोस्टिक्स पर विफल करें।
...
- `blume eject --force` — पहले से इजेक्ट किए गए ऐप पर दोबारा इजेक्ट करें और उसकी `astro.config.mjs` तथा `src/` को ओवरराइट करें।
