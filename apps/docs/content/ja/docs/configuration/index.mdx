...
`github` で Blume にリポジトリを指定します。これはヘッダーの [リポジトリリンク](/docs/content/navigation#repository-link) と、**Edit on GitHub** の [ページアクション](/docs/content/navigation#page-actions) を有効にします:
