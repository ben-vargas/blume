...
Eine Liste ersetzt die generierten Queries für diesen Eintrag; Einträge, die du nicht benennst, behalten ihre. Wie überall gewinnt eine `public/.well-known/ai-catalog.json` (oder `ard.json`), die du selbst ausliefest, über die generierte.
