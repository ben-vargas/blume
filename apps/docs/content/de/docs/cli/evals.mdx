...
- `--threshold <0..1>` – Mindestanteil bestandener Fragen. Liegt der Anteil darunter, endet der Lauf mit einem Exit-Code ungleich null; Fehlschläge bei Fragen mit `severity: warning` zählen dabei als bestanden. Standardmäßig `1`.
