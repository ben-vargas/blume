...
| `Footer` | The site footer after the content grid (built in when [`footer`](/docs/configuration#footer) or [`consent`](/docs/configuration/consent) is set) | `footer`, `site`, `navigation`, `ui` |
